...
it('removes fields if the same variables within a list are used', () => {
    const queryInCache = `
        query {
            things(filter: ["scalar-value", {val: "nested-value", listVal: ["nested-list-value"]}, ["nested-list-value"]]) {
                id
...
it('removes fields if the same inline variables within a list are used', () => {
    const queryInCache = `
        query($filter: Filter) {
...
it('keeps fields if different variables within a list are used', () => {
    const queryInCache = `
        query($filter: Filter) {
