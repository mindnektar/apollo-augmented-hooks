...
var getQueryAst = function getQueryAst(queryAst, client, options) {
  return options.pollInterval || options.fetchPolicy === 'cache-only' ? queryAst : (0, _reducedQueries.makeReducedQueryAst)(client.cache, queryAst, options.variables);
};
...
var _default = function _default(query) {
  ...
  var _useState = (0, _react.useState)(getQueryAst(queryAst, client, options)),
