...
var _apolloClient2 = _interopRequireDefault(require("./apolloClient"));
...
var _default = function _default(query) {
  ...
  var _apolloClient = (0, _apolloClient2["default"])(),
      cache = _apolloClient.cache;
  ...
  var reducedQueryAst = options.pollInterval ? queryAst : (0, _reducedQueries.makeReducedQueryAst)(cache, queryAst);
