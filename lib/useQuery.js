...
var _default = function _default(query) {
  ...
  var queryAst = (0, _client.gql)(query); // Functional default state to avoid recomputing the reduced query on each render.
  ...
  var reducedResult = (0, _client.useQuery)(reducedQueryAst, _objectSpread(_objectSpread({}, options), {}, {
    variables: (0, _pagination.getVariablesWithPagination)(options),
    client: client,
  ...
  return _objectSpread(_objectSpread({}, reducedResult), {}, {
    nextPage: (0, _pagination.handleNextPage)(queryAst, cacheDataRef.current, reducedResult, options.pagination),
