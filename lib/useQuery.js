...
var _default = function _default(query) {
  ...
  var queryAst = (0, _client.gql)(query);
  var variables = (0, _pagination.getVariablesWithPagination)(options);
  var globalContext = (0, _globalContextHook.useGlobalContext)(); // Functional default state to avoid recomputing the reduced query on each render.
  ...
  }, [cacheResult === null || cacheResult === void 0 ? void 0 : cacheResult.data]);
  return _objectSpread(_objectSpread({}, reducedResult), {}, {
    ...
    data: options.inflateCacheData !== false ? (0, _inflateCacheData["default"])(client.cache, cacheResult.data) : cacheResult.data,
