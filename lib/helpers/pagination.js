...
var handleNextPage = function handleNextPage(queryAst, cacheDataRef, reducedResult, options) {
  return /*#__PURE__*/(0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee() {
    var _options$variables, _cacheDataRef$current;
        ...
        switch (_context.prev = _context.next) {
          ...
          case 6:
            ...
            return reducedResult.fetchMore({
              variables: {
                pagination: _objectSpread(_objectSpread({}, options.variables.pagination), getPageOrCursor(options.variables.pagination, data))
              }
            });
