...
var buildLeaf = function buildLeaf(cache, cacheItem, cacheKey) {
  if (!leafCache[cacheKey]) {
    leafCache[cacheKey] = Object.entries(cacheItem).reduce(function (result, _ref) {
      ...
      return _objectSpread(_objectSpread({}, result), {}, (0, _defineProperty2["default"])({}, key, value));
    }, {});
  }
...
var maybeInflate = function maybeInflate(cache, cacheContents, aliases, item, rootQueryKey) {
  ...
  var cacheItemWithAliases = Object.entries(cacheItem).reduce(function (result, _ref3) {
    var _objectSpread3;
...
var inflate = function inflate(cache, cacheContents, aliases, data, rootQueryKey) {
  return Object.entries(data).reduce(function (result, _ref5) {
    ...
    if (Array.isArray(item)) {
      return _objectSpread(_objectSpread({}, result), {}, (0, _defineProperty2["default"])({}, fieldName, item.reduce(function (itemResult, entry) {
        var inflatedEntry = maybeInflate(cache, cacheContents, aliases, entry, rootQueryKey || key);
    ...
    if ((0, _typeof2["default"])(item) === 'object') {
      return _objectSpread(_objectSpread({}, result), {}, (0, _defineProperty2["default"])({}, fieldName, maybeInflate(cache, cacheContents, aliases, item, rootQueryKey || key)));
    }
