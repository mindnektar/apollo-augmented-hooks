...
var hasDuplicateCacheKeySubPaths = function hasDuplicateCacheKeySubPaths(cacheKeyPath, cacheKey) {
  var subPaths = cacheKeyPath.reduce(function (result, key, index) {
...
var maybeInflate = function maybeInflate(cache, cacheContents, aliases, item, cacheKeyPath, itemCache) {
  ...
  if (!itemCache[cacheKey]) {
    ...
    itemCache[cacheKey] = inflate(cache, cacheContents, aliases, cacheItemWithAliases, [].concat((0, _toConsumableArray2["default"])(cacheKeyPath), [cacheKey]), itemCache);
  }
...
var inflate = function inflate(cache, cacheContents, aliases, data, cacheKeyPath, itemCache) {
  return Object.entries(data).reduce(function (result, _ref3) {
    ...
    if (Array.isArray(item)) {
      return _objectSpread(_objectSpread({}, result), {}, (0, _defineProperty2["default"])({}, fieldName, item.reduce(function (itemResult, entry) {
        var inflatedEntry = maybeInflate(cache, cacheContents, aliases, entry, cacheKeyPath, itemCache);
    ...
    if ((0, _typeof2["default"])(item) === 'object') {
      return _objectSpread(_objectSpread({}, result), {}, (0, _defineProperty2["default"])({}, fieldName, maybeInflate(cache, cacheContents, aliases, item, cacheKeyPath, itemCache)));
    }
