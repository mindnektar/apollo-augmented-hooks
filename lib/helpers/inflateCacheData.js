...
var maybeInflate = function maybeInflate(cache, cacheContents, aliases, item, typenamePath, cacheKeyCache) {
  ...
  var itemCacheKey = "".concat(cacheKey, ":").concat(typenamePath.join('.'));
  ...
  if (!itemCache[itemCacheKey]) {
    ...
    itemCache[itemCacheKey] = inflate(cache, cacheContents, aliases, cacheItemWithAliases, [].concat((0, _toConsumableArray2["default"])(typenamePath), [cacheItemWithAliases.__typename]), [].concat((0, _toConsumableArray2["default"])(cacheKeyCache), [cacheKey]));
  }
