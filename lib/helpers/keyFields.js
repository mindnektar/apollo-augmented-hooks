...
var keyFieldsForTypeName = function keyFieldsForTypeName(cache, typeName) {
  var _cache$config$typePol, _cache$config$typePol2;

  return ((_cache$config$typePol = cache.config.typePolicies) === null || _cache$config$typePol === void 0 ? void 0 : (_cache$config$typePol2 = _cache$config$typePol[typeName]) === null || _cache$config$typePol2 === void 0 ? void 0 : _cache$config$typePol2.keyFields) || ['id'];
};
