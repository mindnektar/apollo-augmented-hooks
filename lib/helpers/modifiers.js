...
var toSafeReference = function toSafeReference(cache, toReference, object) {
  var reference = toReference(object);
...
var handleIncludeIf = function handleIncludeIf(cache, item, previous, details) {
  return function (condition) {
    ...
    var subjects = options.subjects || (Array.isArray(item) ? item : [item]);
...
var augmentFields = function augmentFields(cache, cacheObject, item, fields) {
  var modify = function modify(callback, previous, details) {
    ...
    var itemRef = toSafeReference(cache, details.toReference, item);
    ...
    if (typeof cacheObject === 'function') {
      ...
      if (Array.isArray(result)) {
        return result.map(function (resultItem) {
          return cache.identify(resultItem);
        });
      }
...
var handleModifiers = function handleModifiers(cache, item, modifiers) {
  ...
  (0, _reducedQueries.clearReducedQueryCache)();
