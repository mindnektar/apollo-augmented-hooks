...
var handleIncludeIf = function handleIncludeIf(cache, item, previous, details) {
  return function (includeIf) {
    var keyFields = (0, _keyFields.keyFieldsForTypeName)(cache, item.__typename);
    var next = previous.filter(function (ref) {
      return !keyFields.every(function (keyField) {
        return details.readField(keyField, ref) === item[keyField];
      });
    });
...
var handleModifiers = function handleModifiers(cache, item, modifiers) {
  ...
  modifiers.forEach(function (_ref5) {
    var cacheObject = _ref5.cacheObject,
        typename = _ref5.typename,
        fields = _ref5.fields,
        newFields = _ref5.newFields,
        evict = _ref5.evict;
