  ...
  if (ref) {
    if (fieldName) {
      ...
      return Object.values(cacheData).find(function (value) {
        return value.__typename === typename && value[fieldName] !== null && value[fieldName] !== undefined;
      }) || cacheData[ref];
    }
    ...
    if (selection.selectionSet) {
      ...
      if (Array.isArray(cacheObjectOrRef)) {
        var index = cacheObjectOrRef.findIndex(function (item) {
          ...
          return itemCacheObject[fieldName] !== null && itemCacheObject[fieldName] !== undefined;
        });
