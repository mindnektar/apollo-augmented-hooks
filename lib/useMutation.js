    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _ref2 = _args2.length > 0 && _args2[0] !== undefined ? _args2[0] : {}, input = _ref2.input, options = _objectWithoutProperties(_ref2, ["input"]);
            return _context2.abrupt("return", mutate(_objectSpread(_objectSpread({
