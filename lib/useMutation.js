            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  item = options.inflateCacheData !== false ? (0, _inflateCacheData["default"])(cache, result.data[mutationName]) : result.data[mutationName]; // Simplify cache updates after mutations.
