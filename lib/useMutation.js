          ...
          switch (_context2.prev = _context2.next) {
            ...
            case 4:
              ...
              return client.refetchQueries({
                include: 'active',
                onQueryUpdated: function onQueryUpdated(query, _ref4) {
                  var result = _ref4.result;
                  return query.observers.size > 0 && query.options.fetchPolicy !== 'cache-only' && !query.queryName.startsWith('__REDUCED__') && options.lazyRefetch.some(function (fieldName) {
            ...
            case 8:
              ...
              options.lazyRefetch.forEach(function (fieldName) {
                client.cache.evict({
                  fieldName: fieldName,
                  broadcast: false
                });
