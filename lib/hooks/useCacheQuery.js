...
var _default = function _default(queryAst, options) {
  ...
  var dataMapSources = (0, _dataMapSourcesHook.useDataMapSources)(); // Grab all the requested data from the cache. If some or all of the data is missing, the reduced query will get it.
  ...
  return (0, _mapData["default"])(cacheResult.data, options.dataMap, dataMapSources);
};
